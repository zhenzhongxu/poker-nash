...
namespace Aidriven.Poker.Core.XHandEval.PokerSource.Holdem
{
    public partial class Hand : IComparable
    {
        #region Analysis Functions

        public static long[] TwoHandOutcomes(string[] pockets, ref long totalHands)
        {
            if (pockets == null || pockets.Length != 2)
            {
            ...
            int count = 0;
            ulong boardmask = 0UL, deadcards_mask = 0UL, deadcards = Hand.ParseHand(string.Empty, ref count);
            ...
            // Read board cards
            count = 0;
            boardmask = Hand.ParseHand("", string.Empty, ref count);
            ...
            foreach (ulong boardhand in Hands(boardmask, deadcards_mask, 5))
            {
                ...
                if (pockethands[0] == pockethands[1] )
                {
                    //11
                    outcomes[0]++;
                }
                else if (pockethands[0] > pockethands[1] )
                {
                    //12
                    outcomes[1]++;
                }
        ...
        public static long[] ThreeHandOutcomes(string[] pockets, ref long totalHands)
        {
            if (pockets == null || pockets.Length != 3)
            {
                throw new Exception("invalid input");
            }
            ...
            foreach (ulong boardhand in Hands(boardmask, deadcards_mask, 5))
            {
                ...
                if (pockethands[0] == pockethands[1] && pockethands[0] == pockethands[2])
                {
                    //111
                    outcomes[0]++;
                }
                else if (pockethands[0] == pockethands[1] && pockethands[0] > pockethands[2])
                {
                    //113
                    outcomes[1]++;
                }
                else if (pockethands[0] == pockethands[2] && pockethands[0] > pockethands[1])
                {
                    //131
                    outcomes[2]++;
                }
                else if (pockethands[1] == pockethands[2] && pockethands[0] > pockethands[1])
                {
                    //122
                    outcomes[3]++;
                }
                else if (pockethands[0] > pockethands[1] && pockethands[1] > pockethands[2])
                {
                    //123
                    outcomes[4]++;
                }
                else if (pockethands[0] > pockethands[2] && pockethands[2] > pockethands[1])
                {
                    //132
                    outcomes[5]++;
                }
                else if (pockethands[1] > pockethands[0] && pockethands[0] == pockethands[2])
                {
                    //212
                    outcomes[6]++;
                }
                else if (pockethands[0] == pockethands[1] && pockethands[2] > pockethands[0])
                {
                    //221
                    outcomes[7]++;
                }
                ...
                else if (pockethands[2] > pockethands[0] && pockethands[0] > pockethands[1])
                {
                    //231
                    outcomes[9]++;
                }
                else if (pockethands[1] == pockethands[2] && pockethands[1] > pockethands[0])
                {
                    //311
                    outcomes[10]++;
                }
                else if (pockethands[1] > pockethands[2] && pockethands[2] > pockethands[0])
                {
                    //312
                    outcomes[11]++;
                }
                else if (pockethands[2] > pockethands[1] && pockethands[1] > pockethands[0])
                {
                    //321
                    outcomes[12]++;
                }
